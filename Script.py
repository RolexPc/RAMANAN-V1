...
- <a href="https://t.me/creatorbeatz">Jᴏᴇʟ ᠰ TɢX</a></b>"""
    ...
    MANUELFILTER_TXT = """<b>Bro Or Sis, 

Eda mone this feature not working 

എടാ മോനെ ഈ ഫീച്ചർ പ്രവർത്തിക്കുന്നില്ല...</b>"""
...
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/creatorbeatz'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
    ...
    REQINFO = """<b>⚠️ ശ്രദ്ധിക്കുക ⚠️

ഫയൽ ലഭിക്കാൻ ഒരൊറ്റ ഒരു കാര്യം ചെയ്താൽ മതി താഴെ കാണുന്ന 📢 𝑹𝑬𝑸𝑼𝑬𝑺𝑻 𝑻𝑶 𝑱𝑶𝑰𝑵 𝑪𝑯𝑨𝑵𝑵𝑬𝑳 📢 എന്ന ബട്ടണിലോ താഴെ കാണുന്ന ലിങ്കിലോ ക്ലിക്ക് ചെയ്യാവുന്നതാണ്. Join channel ക്ലിക്ക് ചെയ്ത ശേഷം 🔄 Try Again 🔄 എന്ന ബട്ടണിൽ അമർത്തിയാൽ നിങ്ങൾക്ക് ഞാൻ ആ സിനിമ അയച്ചു തരുന്നതാണ്..😍

⚠️ Be careful ⚠️

You only need to do one thing to get the file, you can click on the button below or the link below. After clicking on join channel and pressing 🔄 Try Again 🔄 button I will send you that movie..😍</b>"""
